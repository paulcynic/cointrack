...
class FastAPIClient {
  ...
  getCoins() {
    return this.apiClient.get(`/coins/all`);
  }

  getUserCoins() {
    return this.apiClient.get(`/coins/my-coins/`);
  }

  followCoin(coin, currency, lower, upper, submitter_id) {
    const requestData = {
      coin,
      currency,
      lower,
    ...
    return this.apiClient.post(`/coins/follow/`, requestData);
  }
